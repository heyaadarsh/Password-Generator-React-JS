  ...
  return (
    <>
      ...
      <div className='text-center mt-3'>
        ...
        <input type='text' value={password} readOnly placeholder='hello' className=' bg-slate-100 text-center border-none outline-none sm:px-1md:px-4 py-3 rounded' ref={passwordRef}/>
